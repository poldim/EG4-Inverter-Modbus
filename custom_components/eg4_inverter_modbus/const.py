...
INPUT_REGISTERS: dict[int, EG4ModbusSensorEntityDescription] = {
    ...
    8: EG4ModbusSensorEntityDescription(key="power_pv2", name="Power PV2", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, icon="mdi:solar-power", suggested_display_precision=0),
    ...
    114: EG4ModbusSensorEntityDescription(key="power_load_on_grid", name="Power Load On Grid", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, suggested_display_precision=0),
    ...
    143: EG4ModbusSensorEntityDescription(key="afci_current_ch4", name="AFCI Current CH4", native_unit_of_measurement="mA", device_class=SensorDeviceClass.CURRENT, state_class=SensorStateClass.MEASUREMENT, suggested_display_precision=1, entity_registry_enabled_default=False),
    ...
    170: EG4ModbusSensorEntityDescription(key="power_load", name="Power Load", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, suggested_display_precision=0),
    171: EG4ModbusSensorEntityDescription(key="energy_daily_load", name="Energy Daily Load", native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.TOTAL, suggested_display_precision=1),
    172: EG4ModbusSensorEntityDescription(key="energy_cumulative_load", name="Energy Cumulative Load", native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR, device_class=SensorDeviceClass.ENERGY, state_class=SensorStateClass.TOTAL, suggested_display_precision=1),
    180: EG4ModbusSensorEntityDescription(key="power_inverter_on_grid_l2", name="Power Inverter On Grid L2", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    181: EG4ModbusSensorEntityDescription(key="power_inverter_on_grid_l3", name="Power Inverter On Grid L3", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    ...
    184: EG4ModbusSensorEntityDescription(key="power_grid_output_load_terminal_l2", name="Power Output Grid Terminal L2", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    185: EG4ModbusSensorEntityDescription(key="power_grid_output_load_terminal_l3", name="Power Output Grid Terminal L3", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    186: EG4ModbusSensorEntityDescription(key="power_grid_power_supply_l2", name="Power Grid Supply L2", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    187: EG4ModbusSensorEntityDescription(key="power_grid_power_supply_l3", name="Power Grid Supply L3", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    188: EG4ModbusSensorEntityDescription(key="power_gen_terminal_l2", name="Power Gen Terminal L2", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    189: EG4ModbusSensorEntityDescription(key="power_gen_terminal_l3", name="Power Gen Terminal L3", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, entity_registry_enabled_default=False),
    ...
    191: EG4ModbusSensorEntityDescription(key="current_inverter_rms_l2", name="Current Inverter RMS L3", native_unit_of_measurement=UnitOfElectricCurrent.AMPERE, device_class=SensorDeviceClass.CURRENT, state_class=SensorStateClass.MEASUREMENT, suggested_display_precision=1, entity_registry_enabled_default=False),
    ...
    # --- Calculated Sensors ---
    -1: EG4ModbusSensorEntityDescription(key="power_pv_total", name="Power PV Total", native_unit_of_measurement=UnitOfPower.WATT, device_class=SensorDeviceClass.POWER, state_class=SensorStateClass.MEASUREMENT, icon="mdi:solar-power", suggested_display_precision=0),
